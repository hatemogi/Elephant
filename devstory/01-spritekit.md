...
# 첫 게임 앱을 출시하며 배운 점 - Elephant 개발기 (1)
...
동네 도서관에 갔다가, 신간도서 코너에서 게임 프로그래밍에 관한 책을 발견했습니다. 책 제목을 보고 있노라니 어려서 게임을 만들어보려 했다는 기억이 되살아나더라고요. 마침, 퇴사 후 한가하던 타이밍이라, 친한 게임 제작자 지인 H에게 가서 물어봤습니다. "혹시 작업하다가 버려둔 프로젝트 없어요?" 별 기대 없이 물었는데, 마침 오래전에 '소코반' 아류작을 만들려다가 버려둔 이미지 셋이 있다고 답하지 뭡니까? 
...
여기서 흔하게 빠지게 되는 함정이, "유니티를 써서 개발하면, 이미 많은 사람들이 쓰고 있는 강력한 게임엔진을 배우며 쓸 수도 있고, 멀티 플랫폼 환경 배포도 쉬우니 더 나은 선택이 아닐까?"입니다. 그게 맞을 수도 있습니다. 하지만, 그 강력함을 누리기 위해서 배워야 할 점도 많겠죠. 스프라이트킷은 너무나 단순하기 때문에, 지금 제수준에서는 오히려 나은 선택일 수도 있겠다 싶었습니다. 

"뭐가 더 간단해?"

라는 질문에, 스프라이트킷이라는 결론이 쉽게 도드라졌습니다. 이런 결정에 있어서, 뭐가 맞고 틀리고를 고민하기 시작하면, 결국 맞는(?) 선택은 유니티를 쓰는 게 될 거고, 그러면 전 또 유니티를 공부하다가 세월이 다 갈게 불보듯 뻔했습니다. 유니티를 써본 사람들에게는 유니티가 더 간단한 프레임워크일지도 몰라요. 그저 뉴비 입장에서 첫인상을 놓고 볼 때 스프라이트킷이냐 유니티냐를 놓고 따졌을 때, 느낌으로 스프라이트킷을 쓰기로 결정합니다.

## 첫 출시

중간과정 일단 생략하고, 앱 출시 소식부터 전합니다.
...
현재 버전 기준, 155판까지 출시되어 있는데, 꽤 재미있습니다. 오프라인에서도 플레이 가능하기 때문에, 비행기 같은 데서도 재밌게 즐기실 수 있어요. 머리쓰는 퍼즐 게임 좋아하시면 꽤 재밌을 거예요. 첫판부터 꽤 어렵기 때문에 만만하게 보시면 안 되고요. ㅎ

## 다음 이야기

다음에는, 스프라이트킷의 간단한 구조에 대해서 이야기해 볼까 합니다. 이 글에 '좋아요'를 눌러주시면 다음 글이 빨리 올라옵니다. 핫핫. 여기까지 읽어주셔서 감사합니다.
